	...
	#define PERSIST_BOOL_VARIABLE(Name, Default) QueryRegIntValue(DECLARE_PERSIST_LOAD, #Name, &Name, Default, 0, 1);
	...
	#define PERSIST_BOOL_VARIABLE(Name, Default) SetRegIntValue(DECLARE_PERSIST_SAVE, #Name, Name);
