...
#define CONSTRUCT(n)
	...
	#define PERSIST_TYPED_VARIABLE(Type, Name, Default, Min, Max) QuerySettingsIntValue(DECLARE_PERSIST_LOAD, _T(#Name), (int *)&Name, Default, Min, Max);
	#define PERSIST_FILETIME_VARIABLE(Name) QuerySettingsIntValue(DECLARE_PERSIST_LOAD, _T(#Name) _T("Lo"), &Name.dwLowDateTime, 0xE1D58000); QuerySettingsIntValue(DECLARE_PERSIST_LOAD, _T(#Name) _T("Hi"), &Name.dwHighDateTime, 0x01A8E79F);
	...
	#define PERSIST_FILETIME_VARIABLE_(Name, Key) QuerySettingsIntValue(DECLARE_PERSIST_LOAD, Key _T("Lo"), &Name.dwLowDateTime, 0xE1D58000); QuerySettingsIntValue(DECLARE_PERSIST_LOAD, Key _T("Hi"), &Name.dwHighDateTime, 0x01A8E79F);
